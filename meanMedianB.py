...
if __name__ == '__main__':
	...
	# Plot Seat-share and Mean-Median difference in separate plots
	...
	if isCompressed:
		fig.savefig('meanMedianPackingB{0}quarter.pdf'.format(n))
	else:
		fig.savefig('meanMedianB{0}.pdf'.format(n))
